...
class WhiteStyle : Style() {
    ...
    override fun drawButtonElement(mouseX: Int, mouseY: Int, buttonElement: ButtonElement?) {
        Gui.drawRect(
            ...
            hoverColor(
                if (buttonElement.color != Int.MAX_VALUE) Color(14, 159, 255) else Color(255, 255, 255),
    ...
    override fun drawModuleElement(mouseX: Int, mouseY: Int, moduleElement: ModuleElement?) {
        Gui.drawRect(
            ...
            hoverColor(
                Color(255, 255, 255), moduleElement.hoverTime
            ).rgb
        )
        Gui.drawRect(
            moduleElement.x - 1,
            ...
            moduleElement.y + moduleElement.height + 1,
            hoverColor(
                Color(14, 159, 255, moduleElement.slowlyFade), moduleElement.hoverTime
            ).rgb
        )
        GlStateManager.resetColor()
                ...
                for (value in moduleValues) {
                    ...
                    if (value is BoolValue) {
                        ...
                        Fonts.font35.drawString(
                            ...
                            if (value.get()) Color.BLACK.rgb else Color(120, 120, 120).rgb
                        )
                        ...
                        for (valueOfList in value.values) {
                            ...
                            if (value.openList) {
                                ...
                                Fonts.font35.drawString(
                                    ...
                                    ) Color.BLACK.rgb else Color(120, 120, 120).rgb
                                )
                                moduleElement.slowlySettingsYPos += Fonts.font35.FONT_HEIGHT + 1
                            }
                        }
                        ...
                        val text =
                            value.name + ": " + if (value is BlockValue) getBlockName(value.get()) + " (" + value.get() + ")" else value.get()
