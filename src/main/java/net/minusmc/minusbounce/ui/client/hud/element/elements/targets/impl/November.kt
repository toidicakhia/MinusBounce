...
class November(inst: Target) : TargetStyle("November", inst, true) {
    ...
    val health = (entity.health / entity.maxHealth) * 100 // Convert health to percentage
    val tWidth = 200F
    val tHeight = 40F
    ...
    override fun getBorder(entity: EntityPlayer?): Border {
        entity ?: return Border(0F, 0F, 200F, 40F)
        val tWidth = 200F
        val tHeight = 40F
        val borderColor = Color(245, 0, 70) // Border color (F50046)

        return Border(0F, 0F, tWidth, tHeight, borderColor.rgb)
    }
}
