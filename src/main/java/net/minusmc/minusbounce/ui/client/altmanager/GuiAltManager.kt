 ...
 */
package net.minusmc.minusbounce.ui.client.altmanager
...
import net.minusmc.minusbounce.MinusBounce.fileManager
import net.minusmc.minusbounce.event.SessionEvent
import net.minusmc.minusbounce.ui.client.altmanager.menus.GuiChangeName
import net.minusmc.minusbounce.ui.client.altmanager.menus.GuiLoginIntoAccount
import net.minusmc.minusbounce.ui.client.altmanager.menus.GuiSessionLogin
import net.minusmc.minusbounce.ui.client.altmanager.menus.GuiTheAltening
import net.minusmc.minusbounce.ui.font.Fonts
import net.minusmc.minusbounce.utils.ClientUtils
import net.minusmc.minusbounce.utils.login.LoginUtils
    ...
    private inner class GuiList(prevGui: GuiScreen) : GuiSlot(mc, prevGui.width, prevGui.height, 40, prevGui.height - 40, 30) {
        ...
        val accounts: List<MinecraftAccount>
            get() {
                ...
                return fileManager.accountsConfig.accounts.filter { it.name.contains(search, ignoreCase = true)}
            }
        ...
        override fun drawSlot(id: Int, x: Int, y: Int, var4: Int, var5: Int, var6: Int) {
            ...
            Fonts.font40.drawCenteredString(if (minecraftAccount is CrackedAccount) "Cracked" else if (minecraftAccount is MicrosoftAccount) "Microsoft" else "Something else", width / 2f, y + 15f, if (minecraftAccount is CrackedAccount) Color.GRAY.rgb else Color(118, 255, 95).rgb, true)
        }
