...
// import net.minusmc.minusbounce.ui.client.clickgui.utils.element.components.RangeSlider
// import net.minusmc.minusbounce.ui.client.clickgui.utils.element.module.value.ValueElement
// import net.minusmc.minusbounce.ui.font.Fonts
// import net.minusmc.minusbounce.utils.MouseUtils
// import net.minusmc.minusbounce.utils.render.RenderUtils
// import net.minusmc.minusbounce.value.IntRange
...
//        if (dragged)
//            savedValue.setMinValue((savedValue.minimum + (savedValue.maximum - savedValue.minimum) / sliderWidth * (mouseX - startPoint)).toInt().coerceIn(savedValue.minimum, savedValue.maximum))
...
//        slider.setMinValue(savedValue.getMinValue().coerceIn(savedValue.minimum, savedValue.maximum).toFloat(), savedValue.minimum.toFloat(), savedValue.maximum.toFloat())
//        slider.setMaxValue(savedValue.getMaxValue().coerceIn(savedValue.minimum, savedValue.maximum).toFloat(), savedValue.minimum.toFloat(), savedValue.maximum.toFloat())
...
//        Fonts.font40.drawString("${savedValue.get()}${savedValue.suffix}", x + width + 6F - valueDisplay, y + 10F - Fonts.font40.FONT_HEIGHT / 2F + 2F, -1)
...
//            savedValue.setMinValue((savedValue.get() - 1).coerceIn(savedValue.minimum, savedValue.maximum))
