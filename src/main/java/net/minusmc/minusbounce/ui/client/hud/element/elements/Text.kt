...
class Text(x: Double = 10.0, y: Double = 10.0, scale: Float = 1F,
    ...
    override fun drawElement(): Border {
        ...
        val fadeColor : Int = ColorUtils.fade(Color(redValue.get(), greenValue.get(), blueValue.get(), alphaValue.get()), 0, 100).rgb
    ...
    override fun updateElement() {
        ...
        speedStr = DECIMAL_FORMAT.format(sqrt((lastX - mc.thePlayer.posX).pow(2.0) + (lastZ - mc.thePlayer.posZ).pow(2.0)) * 20 * mc.timer.timerSpeed)
