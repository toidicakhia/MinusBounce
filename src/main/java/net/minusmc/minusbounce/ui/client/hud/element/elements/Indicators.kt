...
class Indicators : Element() {
    private val colorModeValue = ListValue("Color", arrayOf("Custom", "Rainbow", "Sky", "LiquidSlowly", "Fade"), "Custom")
    private val rRed = IntegerValue("Red", 0, 0, 255)
    private val rGreen = IntegerValue("Green", 0, 0, 255)
    private val rBlue = IntegerValue("Blue", 0, 0, 255)
    ...
    override fun drawElement(): Border {
        ...
        RenderUtils.drawRect(xX + 44, yX + 210 - 406, xX + 95, yX + 213.5 - 406, Color(41, 41, 41, 255).rgb)
        RenderUtils.drawRect(xX + 44, yX + 219 - 406, xX + 95, yX + 222.5 - 406, Color(41, 41, 41, 255).rgb)
        RenderUtils.drawRect(xX + 44, yX + 228 - 406, xX + 95, yX + 231.5 - 406, Color(41, 41, 41, 255).rgb)
        RenderUtils.drawRect(xX + 44, yX + 237 - 406, xX + 95, yX + 240.5 - 406, Color(41, 41, 41, 255).rgb)
        ...
        RenderUtils.drawRect(xX + 44, yX + 210 - 406, xX + 44 + armorBarWidth, yX + 213.5 - 406, color.rgb)
    ...
    val color: Color
        get() = when (colorModeValue.get().lowercase()) {
            ...
            "fade" -> ColorUtils.fade(Color(rRed.get(), rGreen.get(), rBlue.get()), 0, 100)
            "liquidslowly" -> ColorUtils.liquidSlowly(System.nanoTime(), 0, saturationValue.get(), brightnessValue.get())
            else -> Color(rRed.get(), rGreen.get(), rBlue.get())
        }
}
